...
$databaseName = isset($_POST['databaseName']) ? preg_replace("/[^\w\s\.\-\,_]/","",$_POST['databaseName']) : 'eFilms';
$databaseLocation = isset($_POST['databaseLocation']) ? preg_replace("/[^\w\s\.\-\,_]/","",$_POST['databaseLocation']) : 'localhost';
...
$structure .= ") ENGINE=MyISAM DEFAULT CHARSET=utf8;\n";
$structure .= "-- -------------------------------------------------------- --\n";
...
$structure .= ") ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=0 ;\n";
$structure .= "-- -------------------------------------------------------- --\n";
