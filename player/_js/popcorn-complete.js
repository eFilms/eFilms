  ...
  */
  ...
  Popcorn.plugin( "timeline" , function( options ) {
	...
	if (typeof options.innerHTML !== "undefined") {
     newInnerHtml= "<br />" + options.innerHTML;
	}
	else {
	newInnerHtml= "";
	}
	...
	if (typeof options.text !== "undefined") {
     newTextToAdd= "<div class='demoText' id='mid'>" + options.text + "</div>";
	}
	else {
	newTextToAdd= "";
	}
	/* Von GK Editiert */
    contentDiv.innerHTML = "<div class='demoPara'><span id='big' class='demoTitle'>" + options.title + "</span>" + newTextToAdd + newInnerHtml + "</div>";
